function [mean_stress, F_mean]= mean_std_stress_nominal(x,L,E,Nelem,h,F)
% Returns the mean of stress and force distribution during uncertain
% loading
% Inputs: 
%     x: Nodal points
%     L: length of spar
...
%     F: Force
% Outputs:
%     mean_stress: mean of stress due to uncertain loading
%     F_mean : meaf of force due to uncertain loading

F0 = F(1);                                  % Force at the root
    ...
    for i2 = 1:size(xi,1)
        ...
        for i3 = 1:size(xi,1)
            ...
            for i4 = 1:size(xi,1)
                ...
                [stress_,~,~,~] = stress_dist_nominal(L,E,Nelem,h,force); 
...
title('Stress distribution: nominal design')
